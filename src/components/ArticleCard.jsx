    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-start sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* タイトル */}
          <h3 className="text-base sm:text-lg font-bold text-gray-900 group-hover:text-[#4a5a7a] transition-colors leading-snug mb-1.5">
            {article.title}
          </h3>
        ...
        {/* 矢印アイコン（PC表示のみ） */}
        <div className="hidden sm:flex items-center self-center text-gray-300 group-hover:text-[#4a5a7a] transition-colors flex-shrink-0">
